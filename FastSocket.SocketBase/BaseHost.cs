...
using FastSocket.SocketBase.Log;
...
namespace FastSocket.SocketBase
{
    public abstract class BaseHost : IHost
    {
        ...
        /// </summary>
        public int SocketBufferSize { get; private set; }
        
        /// <summary>
        /// get message buffer size
        /// </summary>
        public int MessageBufferSize { get; private set; }
        ...
        private class DefaultConnection : IConnection
        {
            ...
            public bool Active
            {
                get => Thread.VolatileRead(ref this._active) == 1;
            }
